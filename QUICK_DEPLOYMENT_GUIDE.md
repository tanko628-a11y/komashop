# ⚡ WordPress デプロイメント クイックガイド

**このドキュメントは短時間でデプロイを完了するための超効率化ガイドです。**
...
### **ステップ 2️⃣: Contact Form 7 をインストール**
...
#### **方法 A: WordPress テーマエディタ使用（推奨）**

```
左メニュー → 外観 → ファイルエディタ
右側パネル: footer.php を開く
```

**footer.php の最後（`</html>` 前）に以下を追加:**
...
詳細は **WORDPRESS_DEPLOYMENT_CHECKLIST.md** を参照してください。
